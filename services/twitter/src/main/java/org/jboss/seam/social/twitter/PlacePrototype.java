 ...
 * This is the type returned from calls to {@link GeoService#findSimilarPlaces(double, double, String)}.
 * It is the only type that can be given to {@link GeoService#createPlace(PlacePrototype)} to create a new place.
