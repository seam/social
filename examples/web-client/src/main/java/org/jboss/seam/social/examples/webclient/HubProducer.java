...
public class HubProducer {
    ...
    @Twitter
    @ApplicationScoped
    @OAuthApplication(apiKey = "FQzlQC49UhvbMZoxUIvHTQ", apiSecret = "VQ5CZHG4qUoAkUUmckPn4iN4yyjBKcORTW0wnok4r1k", callback = "http://localhost:8080/social-web-client/callback.jsf")
    @Produces
    ...
    @LinkedIn
    @ApplicationScoped
    @OAuthApplication(apiKey = "ympq1JR_oxeC3qZE4VwiDEr-9Rc9Am0YE1AJwwXJNREfqaF7J6hXfsncu_JFd13W", apiSecret = "RwDk21M6qQeGT_zi2icmZV6tc5VsjRZPm7DWDIVt0Wsqu2eYBXt4Csg-FUbBZIIH", callback = "http://localhost:8080/social-web-client/callback.jsf")
    @Produces
    ...
    @Facebook
    @ApplicationScoped
    @OAuthApplication(apiKey = "204631749555557", apiSecret = "5d3132b1448a66d28e5c420b267cd65e", callback = "http://localhost:8080/social-web-client/callback.jsf")
    @Produces
